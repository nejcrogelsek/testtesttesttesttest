...
import { ErrorAction, LoadingAction } from 'store/models/Action'
import { ModalProps } from 'store/models/Modal'
import { Snackbar } from 'store/models/Snackbar'
...
const globalSlice = createSlice({
  ...
  reducers: {
    ...
    addModal(state, action: PayloadAction<ModalProps>) {
      state.modal = Object.assign(Object.assign({}, state.modal), action.payload)
    },
    removeModal(state) {
      state.modal = null
    },
